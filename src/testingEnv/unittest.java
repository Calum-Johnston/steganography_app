...
public class unittest {
    ...
    public void runTests() {
        ...
        String image_name = "test_image_gray";
        try{
            coverImage = ImageIO.read(new File("C:\\Users\\Calum\\Documents\\Projects\\Dissertation\\Dissertation Project\\src\\testingEnv\\testdata\\" + image_name + ".png"));
        }catch(Exception e){}
        ...
        //text = "a";
        text = text.substring(0, (text.length() / 25) * 7);
        long startTime = System.currentTimeMillis();

        sobelEdgeDetection sobel = new sobelEdgeDetection();
        sobel.getEdgePixels(coverImage, 856);
